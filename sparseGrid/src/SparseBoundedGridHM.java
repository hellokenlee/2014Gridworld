...
public class SparseBoundedGridHM<E> extends AbstractGrid<E>{
	...
	private int maxRow;
	//methods
	public SparseBoundedGridHM(int rows,int cols){
		if (rows <= 0)
        ...
        occupantArray.clear();
        System.out.println("SparseBoundedGridHM ["+maxRow+"]"+"["+maxCol+"] has been created!");
	}
